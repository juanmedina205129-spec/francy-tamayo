...
<main class="category-page category-paintings">
    <section class="category-hero">
        <div class="container category-hero-content">
            <span class="category-pill">Colección de arte</span>
            <h1>Pinturas</h1>
            <p>Óleo y acuarela sobre lienzo. Cada pieza es única, hecha a mano y firmada por la artista.</p>
        </div>
    </section>
    ...
    <section class="category-store">
        <div class="container">
            <div class="category-note">
                ...
                <p>Nuestra colección de pinturas incluye obras al óleo y acuarela sobre lienzo de alta calidad. Cada pieza es original, única y viene firmada por la artista.</p>
            </div>
