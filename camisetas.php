                ...
                <article class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-footer">
                            ...
                            <button class="add-to-cart" data-product="Camiseta Perro Acuarela" data-category="Camiseta" data-price="85000" data-image="assets/imagenes/productos/estuche-azulejo.png">Añadir</button>
                        </div>
                    </div>
                </article>
                ...
                <article class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-footer">
                            ...
                            <button class="add-to-cart" data-product="Camiseta Gato Minimalista" data-category="Camiseta" data-price="75000" data-image="assets/imagenes/productos/estuche-plumas.png">Añadir</button>
                        </div>
                    </div>
                </article>
                ...
                <article class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-footer">
                            ...
                            <button class="add-to-cart" data-product="Camiseta Tigre Estampado" data-category="Camiseta" data-price="90000" data-image="assets/imagenes/productos/estuche-golondrina.png">Añadir</button>
                        </div>
                    </div>
                </article>
                ...
                <article class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-footer">
                            ...
                            <button class="add-to-cart" data-product="Camiseta Mascota Personalizada" data-category="Camiseta por encargo" data-price="110000" data-image="assets/imagenes/productos/estuche-buho.png">Añadir</button>
                        </div>
                    </div>
                </article>
            </div>
