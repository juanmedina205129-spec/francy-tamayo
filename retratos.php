            ...
            <div class="product-grid category-products portraits-products">
                <article class="product-card">
                    <div class="product-image">
                        ...
                        <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image10.png" alt="Retrato mascota personalizado">
                    </div>
                    <div class="product-body">
                        ...
                        <div class="product-footer">
                            ...
                            <button class="add-to-cart" data-product="Retrato mascota personalizado" data-category="Retrato por encargo" data-price="220000" data-image="assets/imagenes/img/image10.png">Añadir</button>
                        </div>
                    </div>
                </article>
                ...
                <article class="product-card">
                    <div class="product-image">
                        <span class="badge custom">Por encargo</span>
                        <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image15.png" alt="Retrato canino clasico">
                    </div>
                    <div class="product-body">
                        <span>Por encargo</span>
                        ...
                        <div class="product-footer">
                            ...
                            <button class="add-to-cart" data-product="Retrato canino clásico" data-category="Retrato por encargo" data-price="250000" data-image="assets/imagenes/img/image15.png">Añadir</button>
                        </div>
                    </div>
                </article>
                ...
                <article class="product-card">
                    <div class="product-image">
                        <span class="badge custom">Por encargo</span>
                        <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image16.png" alt="Retrato doble mascotas">
                    </div>
                    <div class="product-body">
                        <span>Por encargo</span>
                        ...
                        <div class="product-footer">
                            ...
                            <button class="add-to-cart" data-product="Retrato doble mascotas" data-category="Retrato por encargo" data-price="380000" data-image="assets/imagenes/img/image16.png">Añadir</button>
                        </div>
                    </div>
                </article>
            </div>
