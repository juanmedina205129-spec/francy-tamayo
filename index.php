        ...
        <div class="container">
            ...
            <div class="category-grid">
                <article class="category-card" id="pinturas">
                    <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image6.png" alt="Pintura artistica">
                ...
                <article class="category-card" id="retratos">
                    <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image7.png" alt="Retrato personalizado">
                    <div class="category-body">
                ...
                <article class="category-card" id="camisetas">
                    <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image8.png" alt="Camiseta ilustrada">
                    <div class="category-body">
            ...
            <div class="product-grid">
                <article class="product-card" id="producto-pinturas">
                    <div class="product-image">
                        ...
                        <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image9.png" alt="Pintura al oleo">
                    </div>
                ...
                <article class="product-card" id="producto-retratos">
                    <div class="product-image">
                        ...
                        <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image10.png" alt="Retrato personalizado">
                    </div>
                    <div class="product-body">
                ...
                <article class="product-card" id="producto-camisetas">
                    <div class="product-image">
                        <span class="badge available">Disponible</span>
                        <img src="<?php echo BASE_URL; ?>assets/imagenes/img/image11.png" alt="Camiseta artistica">
                    </div>
                    <div class="product-body">
                        <span>Camiseta</span>
